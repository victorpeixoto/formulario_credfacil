    ...
    <div className="flex flex-col items-center gap-5 py-2">
      ...
      {whatsappLink && (
        <a
          ...
          className="w-full py-4 rounded-2xl bg-green-500 hover:bg-green-600 active:scale-95 text-white font-semibold text-lg text-center transition-all duration-200 flex items-center justify-center gap-2"
        >
      ...
      {!whatsappLink && !carregando && (
        <p className="text-gray-400 text-sm text-center">
          Entre em contato conosco para finalizar o processo.
        </p>
      )}
    </div>
  );
