      ...
      <div className="flex items-center gap-3">
        {onVoltar && (
          <button
            ...
            type="button"
            aria-label="Voltar"
            className="w-9 h-9 -ml-1 rounded-full flex items-center justify-center hover:bg-gray-100 active:scale-95 transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:pointer-events-none touch-manipulation"
          >
